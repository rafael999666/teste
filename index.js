            ...
            case 'kangcopet':
			    ...
			    case 'hentai2':
				    try {
						...
						res = await fetchJson(`https://www.luscious.net/albums/random-pictures-22_94874/`, {method: 'get'})
						buffer = await getBuffer(res.result)
						client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Se liga nessa gostosa😏'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply(' *;-;* ')
					}
